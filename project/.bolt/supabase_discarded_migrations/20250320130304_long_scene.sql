/*
  # Fix Payment_plan Table Casing

  1. Changes
    - Rename payment_plan to Payment_plan
    - Update all references in functions and triggers
    - Update foreign key constraints and indexes
    - Recreate policies with correct table name

  2. Notes
    - Maintains all existing functionality
    - Updates all references to use correct casing
*/
